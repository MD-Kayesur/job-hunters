      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[600px] gap-8">
          ...
          <div className="flex-1 text-left z-20 py-12">
            ...
            >
              <h1 className="text-5xl lg:text-[88px] font-[900] text-[#2d3748] leading-[1.15] lg:leading-[1.0] tracking-tight mb-6 lg:mb-8">
                Discover <br />
                more than <br />
                <span className="text-[#3b82f6] relative inline-block">
                  5000+ Jobs
                  <svg className="absolute -bottom-4 lg:-bottom-5 left-0 w-full" height="18" viewBox="0 0 400 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5 13C60 7 240 7 390 13.5" stroke="#3b82f6" strokeWidth="4" strokeLinecap="round" opacity="0.9" />
                    <path d="M10 15C80 9.5 280 9.5 395 14" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round" opacity="0.7" />
                    <path d="M4 11C100 5 300 5 385 11" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" opacity="0.6" />
                  </svg>
                </span>
              </h1>
              ...
              <div className="bg-white shadow-[0_15px_50px_-15px_rgba(0,0,0,0.1)] rounded-2xl p-4 md:p-2 flex flex-col md:flex-row items-center gap-4 md:gap-0 w-full max-w-4xl border border-gray-100">
                <div className="flex items-center gap-4 px-2 md:px-6 py-3 md:py-5 flex-[1.5] w-full border-b md:border-b-0 md:border-r border-gray-100">
                ...
                <div className="flex items-center gap-4 px-2 md:px-6 py-3 md:py-5 flex-1 w-full relative group">
                  ...
                  <RiArrowDownSLine className="absolute right-2 md:right-6 text-gray-400 text-2xl pointer-events-none" />
                </div>
          ...
          {/* Right Image Side */}
          <div className="hidden lg:flex flex-1 relative self-end lg:h-[700px] w-full items-end justify-end">
          ...
          <div className="lg:hidden absolute inset-0 z-0 pointer-events-none opacity-[0.15]">
            <img
              src={pattern}
              alt=""
